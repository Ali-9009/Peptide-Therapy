...
import { ShieldCheck, Truck, Tag, ShoppingBag, Minus, Plus, Trash2, Phone } from "lucide-react";
                ...
                <div className="grid gap-6 lg:grid-cols-[1fr_420px]">
                    ...
                    <aside className="lg:sticky lg:top-22 lg:self-start">
                        ...
                        <div className="rounded-xl p-4 shadow-md ring-1 ring-gray-200">
                            ...
                            {items.length === 0 ? (
                                <div className="rounded-xl border border-gray-200 p-6 mb-6 text-center shadow-sm hover:shadow-md duration-300">
                                    <ShoppingBag
                            ...
                            {/* {items.length === 0 ? (
                                <Button disabled text="Cart is Empty" className="w-full bg-gray-300 hover:bg-gray-300 font-bold text-gray-600" />
                            ) : (
